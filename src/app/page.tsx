...
import Layout from "@/components/Layout"; // Ensure Layout is appropriate for client-side if needed
            ...
            <div className="flex flex-col justify-center space-y-4">
              ...
              <a 
                ...
                <a
                  ...
                  className="flex items-center gap-2 border border-gray-500 px-4 py-2 rounded-md hover:bg-gray-100"
                >
